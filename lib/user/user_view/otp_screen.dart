          ...
          child: RichText(
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  text: '$phoneNumber',
                  style: TextStyle(color: SharedColors.blue),
                ),
              ],
            ),
          ),
    ...
    return Container(
      child: PinCodeTextField(
        ...
        pinTheme: PinTheme(
          ...
          fieldWidth: 40,
          borderWidth: 1,
          activeColor: SharedColors.blue,
          inactiveColor: SharedColors.blue,
          inactiveFillColor: Colors.white,
          activeFillColor: SharedColors.lightBlue,
          selectedColor: SharedColors.blue,
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      icon: Icon(
       ...
       title: Text('OtpScreen',style: TextStyle(color: SharedColors.blackWhiteColor),),
       centerTitle: true,
        ),
        body: 
           Container(
