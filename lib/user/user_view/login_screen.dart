        ...
        Expanded(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: SharedColors.blackWhiteColor),
      ...
      listener: (context, state) {
        ...
        if (state is PhoneNumberSubmited) {
         ...
         // Navigator.of(context).pushNamed('/otp_screen', arguments: phoneNumber);
          Navigator.of(context).push(MaterialPageRoute(builder: (_)=>OtpScreen(phoneNumber:phoneNumber)));
        }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      icon: Icon(
       ...
       title: Text('LoginScreen',style: TextStyle(color: SharedColors.blackWhiteColor),),
       centerTitle: true,
        ),
        body: Form(
          key: _phoneFormKey,
